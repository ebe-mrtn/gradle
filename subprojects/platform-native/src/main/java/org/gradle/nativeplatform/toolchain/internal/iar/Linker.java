...
class Linker extends AbstractCompiler<LinkerSpec> {
    Linker(BuildOperationExecutor buildOperationExecutor, CommandLineToolInvocationWorker commandLineToolInvocationWorker, CommandLineToolContext invocationContext, boolean useCommandFile, WorkerLeaseService workerLeaseService) {
    ...
    protected void addOptionsFileArgs(List<String> args, File tempDir) {
        new IarOptionsFileArgsWriter(tempDir).execute(args);
    }
