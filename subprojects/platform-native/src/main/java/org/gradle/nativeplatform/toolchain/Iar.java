 ...
 */
@Incubating
public interface Iar extends NativeToolChain {
    /**
     ...
     */
    void target(String platformName, Action<? super NativePlatformToolChain> action);
     ...
     */
    void eachPlatform(Action<? super IarPlatformToolChain> action);
}
