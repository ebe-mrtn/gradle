...
class Assembler extends IarNativeCompiler<AssembleSpec> {
    ...
    Assembler(BuildOperationExecutor buildOperationExecutor, CompilerOutputFileNamingSchemeFactory compilerOutputFileNamingSchemeFactory, CommandLineToolInvocationWorker commandLineTool, CommandLineToolContext invocationContext, String objectFileExtension, boolean useCommandFile, WorkerLeaseService workerLeaseService) {
        super(buildOperationExecutor, compilerOutputFileNamingSchemeFactory, commandLineTool, invocationContext, new AssemblerArgsTransformer(), Transformers.noOpTransformer(), objectFileExtension, useCommandFile, workerLeaseService);
    }
    ...
    private static class AssemblerArgsTransformer  extends IarCompilerArgsTransformer<AssembleSpec> {
        @Override
...
//
//            args.add("-o");
//            args.add(spec.getObjectFileDir().getAbsolutePath());
//
//            return args;
//        }
    }
