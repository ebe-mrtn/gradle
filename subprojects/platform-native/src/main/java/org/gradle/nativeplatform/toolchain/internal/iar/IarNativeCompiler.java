...
class IarNativeCompiler<T extends NativeCompileSpec> extends NativeCompiler<T> {
    ...
    protected void addOptionsFileArgs(List<String> args, File tempDir) {
        OptionsFileArgsWriter writer = new IarOptionsFileArgsWriter(tempDir);
